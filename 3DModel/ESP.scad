...
// --- NodeMCU V3 Lolin -------------------------
module GOOOUUU(pins=0, phmc="Yellow", phfc="DarkGrey") {
    // NodeMCU V3 (LoLin)
...
module esp01s_relay(board_w=36.55, board_h=25, board_t=1.6,
                    relay_w=19, relay_h=15, relay_t=16,
                    esp_w=10, esp_h=5, esp_t=8,
                    term_w1=10, term_h1=9, term_t1=6.4,
                    term_w2=5.5, term_h2=9, term_t2=6.4,
    ...
    translate([board_w-esp_w-1.46, 0, board_t])
        color("yellow")
        cube([esp_w, esp_h, esp_t]);

    // Screw terminal (near relay)
    translate([0.33, 0, board_t])
        color("#92cf6c")
        cube([term_w1, term_h1, term_t1]);
    
    // Screw terminal (near relay)
    translate([0.33+term_w1+2.34, 0, board_t])
        color("#92cf6c")
